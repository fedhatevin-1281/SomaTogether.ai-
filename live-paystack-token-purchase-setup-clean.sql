-- Live Paystack Token Purchase Setup - Clean Version
...
BEGIN
  ...
  v_amount_ngn := (v_transaction_data->>'amount')::numeric / 100;
  v_amount_usd := v_amount_ngn * 0.0007;
...
BEGIN
  ...
  v_amount_ngn := p_amount_usd * 1500;
