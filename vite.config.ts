...
export default defineConfig({
  ...
  plugins: [
    react(),
    {
      name: 'copy-landing-page-only',
      writeBundle() {
        // Copy only landing page and CSS files to build directory
        ...
        // Copy video files
        const videoFiles = ['11025555-hd_4096_2160_25fps.mp4', '11025549-hd_4096_2160_25fps.mp4'];
