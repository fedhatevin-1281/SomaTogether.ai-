...
-- =====================================================
-- This script removes problematic user triggers without touching system triggers
-- Run this to fix the 500 signup error immediately

-- =====================================================
-- 1. DROP ALL USER-CREATED TRIGGERS
-- =====================================================

-- Drop all user-created triggers (avoiding system triggers)
...
-- =====================================================
-- 3. CREATE ESSENTIAL TABLES (IF NOT EXISTS)
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '=====================================================';
    RAISE NOTICE '✅ Dropped all user-created triggers';
